...
path_2 = '/home/qimaqi/workspace_ra/VH_group/TCMR_RELEASE/video/xxxxxxxx/overlap'
path_3 = '/home/qimaqi/workspace_ra/VH_group/TCMR_RELEASE/video/xxxxxxxx/dynamic'
save_path = '/home/qimaqi/workspace_ra/VH_group/TCMR_RELEASE/video/xxxxxxxx/concat_overlap'
...
for i in tqdm(range(args.start_frame+1, args.end_frame)):
    ...
    overlap_image_path = osp.join(path_2, str(i).zfill(4)+'.png')
    bar_image_path = osp.join(path_3, str(i).zfill(4)+'.png')
    input_image = Image.open(input_image_path)
    overlap_image = Image.open(overlap_image_path)
    bar_image = Image.open(bar_image_path)
    width,height = overlap_image.size
    overlap_image = overlap_image.crop((400,0,1400,height))
    im_file_list = [input_image, overlap_image,bar_image]
